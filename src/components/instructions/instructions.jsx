      ...
      <Grid
        ...
        <Grid item xs={12} align='left'>
          <div style={{"margin-right":"50px"}} className={ classes.root } >
            <Typography className={ classes.header }>With acentridge you can:</Typography>
            <li><Typography className={ classes.action }>Swap between ERC20 and Acent tokens</Typography></li>
            <li><Typography className={ classes.action }>Launch ACENT assets</Typography></li>
            <li><Typography className={ classes.action }>List tokens on Acent DEX</Typography></li>
          </div>
          <div className={ classes.root } >
            <Typography className={ classes.header }>Acentridge fees:</Typography>
              <Grid
                container
                justify="flex-start"
                alignItems="flex-end">
