      ...
      <React.Fragment>
        ...
        <Typography className={ classes.instructionUnderlined }>
          ...
          <Typography className={ classes.instructionBold }>
            Transfer {listProposalFee + depositFee} acent
          </Typography>
    ...
    return (
      <React.Fragment>
        <Grid item xs={ 12 } className={ classes.frame }>
          ...
          <Typography className={ classes.instructions }>
            The next steps require Acent validators to vote on whether they want the token listed on the DEX. Once 50% of the validators vote "Yes", you will need to submit the list transaction.
          </Typography>
          <Typography className={ classes.instructions }>
    ...
    return (
      <React.Fragment>
        ...
        <Grid item xs={ 12 } className={ classes.frame }>
          ...
          <Typography className={ classes.instructionBold }>
            This token listed on Acent DEX.
          </Typography>
          <Typography className={ classes.instructions }>
  ...
  renderGettingList = () => {
    ...
    return (
      <Grid item xs={ 12 } className={ classes.frame }>
        ...
        <Typography className={ classes.instructions }>
          This token has a previous token listing proposal submitted to Acent.
        </Typography>
        <Typography className={ classes.instructions }>
      ...
      <React.Fragment>
        <Grid item xs={ 12 } className={ classes.frame }>
          ...
          </Typography>
          {
            ...
            <Typography className={ classes.instructions }>
              Once the vote has passed you will be able to list the token on the Acent DEX
            </Typography>
          }
        </Grid>
        {
